...
namespace Moqikaka.GameServer.SGH5.BLL
{
    ...
    public class GlobalFightReportBLL
    {
        ...
        public static void ClearExpiredDataToOneHour(DateTime dtNow)
        {
            ...
            {
                LogUtil.Write($"GlobalFightReportBLL.ClearExpiredDataToOneHour：清理战报异常{ex.Message + Environment.NewLine + ex.StackTrace}", LogType.Error);
            }
        }
